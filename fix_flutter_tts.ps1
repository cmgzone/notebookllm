...
$ttsPath = "C:\Users\Admin\AppData\Local\Pub\Cache\hosted\pub.dev\flutter_tts-4.2.3\windows\CMakeLists.txt"
Set-Content -Path $ttsPath -Value $content -Encoding UTF8 -Force
Write-Host "Fixed flutter_tts CMakeLists.txt at $ttsPath"
