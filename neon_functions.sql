-- ============================================
-- NEON POSTGRESQL FUNCTIONS FOR NOTEBOOK LLM
-- ============================================
-- This file contains all database functions for the backend
-- Run this after your initial schema is created
...
-- Clean up orphaned media (sources without notebooks)
...
-- Auto-update notebook updated_at when sources change
...
-- Auto-delete orphaned tags (tags with no sources)
...
-- ============================================
-- 7. SHARING & COLLABORATION FUNCTIONS
-- ============================================
