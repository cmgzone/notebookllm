...
class ProfileScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final isMe = userId == null || userId == authState.user?.uid;

    // For now, only support current user profile
    // In a full implementation, we'd fetch another user's profile here
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: Stack(
                ...
                children: [
                  ...
                  // Profile Info at the bottom of the header
                  Positioned(
                    bottom: 24,
                    left: 24,
                    right: 24,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      _buildStat(context, '0', 'Notebooks', LucideIcons.book),
                      _buildStat(context, '0', 'Friends', LucideIcons.users),
                      _buildStat(context, '0', 'Groups', LucideIcons.layers),
                    ],
